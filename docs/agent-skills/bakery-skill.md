...
Use this skill when the user wants to scaffold a new project with modern TypeScript tooling. Bakery supports multiple archetypes: CLI tools, REST APIs, full-stack apps, and Effect-based projects.

## When to Use This Skill

- User asks to "create a CLI tool" or "scaffold a project"
- User wants to build a command-line application with TypeScript
- User mentions needing a project with modern tooling (Bun, Biome, etc.)
- User asks about creating a distributable CLI binary
- User wants to scaffold a REST API or full-stack application
